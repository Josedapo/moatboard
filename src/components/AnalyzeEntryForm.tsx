...
//
// Post-2026-04-28: the prior-state reminder block was removed when
// ticker_states collapsed into pure watchlist tags. Re-entering an
// analyzed ticker simply resumes its session.
